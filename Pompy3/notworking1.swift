...
////    @State var prevPosition = SIMD3<Float>()
//    let prevEntity: Entity? = nil
//
//    
...
//                if value != "" {
//                    let position = prevEntity?.position
//                    if let prevEntity = prevEntity { parentEntity.removeChild(prevEntity)
//                    }
...
//                    if let position = position {entity.position = position }
